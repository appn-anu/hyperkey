#!/usr/bin/env python3
# Processing procedure by Ming Chia
# Implemented by Google Gemini 3 Pro Preview

# Usage: python CanolaS2S-integrate-reflectances.py data-in.csv <path to raw data folder> data-integrated.csv

### GENERATION PROMPT:

# Hi Gemini, please write a Python script to append data from files to a CSV spreadsheet.
#
